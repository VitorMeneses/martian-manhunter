#specific class with algorithm training data
...
class training:
    base_training = [
        ...
        ('não gosto de dotnet', 'raiva'),
        ('não gosto de .dot', 'raiva'),
        ...
        ('eu adeio o dotnet', 'raiva'),
        ('eu odeio o .net', 'raiva'),
        ('dotnet', 'raiva'),
        ...
        ('o swg subiu','surpresa'),
        ('o swg está em prd', 'surpresa'),
        ('o swg está em produção', 'surpresa'),
